...
#
#
# cpds_cleanUpProject.sh: This script will clean up artifacts for the specified deployed project in Content Platform Engine repository and the associated Content Analyzer project.
#
#   This scripts removes documents and metadata from the Content Platform Engine repository and removes the associated Content Analyzer Project information.
#   
...
{
    echo "NAME"
    echo "  $0 -- clean up artifacts for the specified deployed project in Content Platform Engine repository and the associated Content Analyzer project. "
    echo ""
    echo "USAGE: $0  "
