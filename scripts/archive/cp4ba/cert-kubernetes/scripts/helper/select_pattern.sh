...
# This function support mutiple checkbox, if do not select anything, it will return None
    ...
    zlinux_custom_tips="\x1B[33;5mATTENTION: \x1B[0m\x1B[1;31mIBM Automation Document Processing (7a/7b) does NOT support a cluster running a Linux on Z (s390x) architecture.\n\x1B[0m"
    indexof() {
        i=-1
