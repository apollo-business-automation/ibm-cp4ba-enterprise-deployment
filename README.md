...
data:
  variables.yml: |
    ...
    ## Set to false if you provide your own LDAP, madatory to set the lc_ variables bellow
    openldap_enabled: true

    # apollo-one-shot deployment installs its own OpenLdap server. 
    # If you do not want to use it and have an external LDAP server you prefer, then uncomment the lc_ variables and fill the values.
    ...
    # IMPORTANT: Also create the external ldap secret that is bellow and put its name into lc_custom_config_secret
    # 
    ...
    # 
    ## LDAP Specific Type settings 
    ## For TDS prefix with lc_tds instead of just lc_ and for AD prefix with lc_ad
    # lc_tds_user_filter: "(&(cn=%v)(objectclass=inetOrgPerson))"
    # lc_tds_group_filter: "(&(cn=%v)(|(objectclass=groupofnames)(objectclass=groupofuniquenames)(objectclass=groupofurls)))"
